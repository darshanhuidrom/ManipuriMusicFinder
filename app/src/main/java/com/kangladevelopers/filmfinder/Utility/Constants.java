...
public class Constants {
    ...
    public static final String PRODUCTION_URL = "http://ec2-52-27-114-111.us-west-2.compute.amazonaws.com:8080/leichal/webapi/";//production
    public static final String PRODUCTION_URL_BASE = "http://ec2-52-27-114-111.us-west-2.compute.amazonaws.com/";// production
    ...
    public static final String APP_PACKAGE_NAME = "com.kangladevelopers.manipur_mami";
    public static final String YOUTUBE_DOWDLOADER_LINK = PLAYSTORE_MARKET_LINK + YOUTUBE_PACKAGE_NAME;
    public static final String APP_DOWNDLOADERILINK = PLAYSTORE_MARKET_LINK + APP_PACKAGE_NAME;
