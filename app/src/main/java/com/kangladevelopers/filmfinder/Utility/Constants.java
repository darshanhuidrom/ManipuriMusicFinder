...
public class Constants {
    ...
    public static final String PERSON_ICON_PIC_URL = PRODUCTION_URL + "leichal/person_icon/";
    public static final String BIO_DATA__ICON_PIC_URL = PRODUCTION_URL + "leichal/bio_data_pic/";
    ...
    // Related to Help
    public static final String ABOUT_URL = PRODUCTION_URL + "leichal/ManipurMami/about.html";
    public static final String FAQ_URL = PRODUCTION_URL + "leichal/ManipurMami/faq.html";
    public static final String TERMS_PRIVACY_URL = PRODUCTION_URL + "leichal/ManipurMami/tnc.html";
    public static final String CONTACT_US_URL = PRODUCTION_URL + "leichal/ManipurMami/contact_us.html";
